  ...
  return (
    <>
      <div
        ...
        className="container text-center items-center flex space-x-12 flex-row mt-10 py-7 px-7 justify-center bg-gradient-to-br from-indigo-600 to-blue-300 rounded-xl shadow max-w-lg"
      >
        <div className="-mr-2">
        ...
        <div className="m-30">
          <p data-testid="location" className="semi-bold text-3xl text-white">
            {data.name}
          </p>
          {data.main ? (
      ...
      <div className="container justify-center text-center items-center flex space-x-8 flex-row my-3">
        <div
          data-testid="wind-container"
          className="py-2 w-60 bg-gradient-to-br from-indigo-500 to-blue-300 rounded-full shadow"
        >
        ...
        <div
          data-testid="humidity-container"
          className="py-2 w-60 bg-gradient-to-br from-indigo-500 to-blue-300 rounded-full shadow"
        >
